...
#else
#define HOST_IP_ADDR 10.0.0.250
#endif
...
static void parse_json(void *pvParameters) {
    ...
    const cJSON *delayStart = NULL;
    const cJSON *rampePWM = NULL;
    const cJSON *pulseWelding = NULL;
    const cJSON *speedBalayage = NULL;
    const cJSON *speedWelding = NULL;
    const cJSON *speedWire = NULL;
    const cJSON *balayage = NULL;
